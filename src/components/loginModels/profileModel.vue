      ...
      <div class="profile-list">
        <ul>
          ...
          <li>
            ...
            <input type="text" :value= $store.state.userInfo.name  readonly />
          </li>
          <li>
            <svg class="svg-icon" viewBox="0 0 20 20">
              <path
             ...
             <input type="text" :value= $store.state.userInfo.email readonly />
          </li>
          <li>
            <svg class="svg-icon" viewBox="0 0 20 20">
              <path
            ...
            <input type="text" :value= $store.state.userInfo.phone_number readonly/>
          </li>
          <li>
            <svg class="svg-icon" viewBox="0 0 20 20">
              <path
            ...
            <input type="text" :value= $store.state.userInfo.estate_name readonly />
          </li>
        </ul>
        <div class="premium">
          <h2>Premium Ads</h2>
